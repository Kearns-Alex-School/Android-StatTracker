...
/**
 * Ability array adapter.
 * @see CharacterAdapter
 * @author Alex Kearns
 */
public class AbilityAdapter extends ArrayAdapter<InventoryDataModel> implements View.OnClickListener {
    ...
    public AbilityAdapter(ArrayList<InventoryDataModel> data, Context context) {
                ...
                b_Confirm.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        for (int index = 0; index < character.abilities.size(); index++)
                            if (character.abilities.get(index).name.equals(dataModel.getName()))
